...
#define UI_DISPLAY_RS_PIN		1		// PINK.1, 88, D_RS
#define UI_DISPLAY_RW_PIN		-1
#define UI_DISPLAY_ENABLE_PIN	        3		// PINK.3, 86, D_E
...
#define UI_DISPLAY_D4_PIN		0		// PINF.5, 92, D_D4
#define UI_DISPLAY_D5_PIN		2		// PINK.2, 87, D_D5
#define UI_DISPLAY_D6_PIN		4		// PINL.5, 40, D_D6
#define UI_DISPLAY_D7_PIN		6		// PINK.4, 85, D_D7
...
void ui_init_keys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(5,7); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
  UI_KEYS_INIT_BUTTON_LOW(39); // push button, connects gnd to pin
...
void ui_check_keys(int &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(5,7); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
 UI_KEYS_BUTTON_LOW(39,UI_ACTION_OK); // push button, connects gnd to pin
